...
export const path = {
    abs: {
        ...
        vsDevenv: '/mnt/c/Program\\ Files\\ \\(x86\\)/Microsoft\\ Visual\\ Studio/2019/Community/Common7/IDE/devenv.com',
    },
    rel: {
...
export const cmd = {
    rsync: (relPath: string) => `rsync ${flags.join(' ')} ${path.abs.src}${relPath} ${remoteHost}:${path.abs.dest}${relPath}`,
